...
const LiquidEther: React.FC<LiquidEtherProps> = ({
    ...
    useEffect(() => {
        ...
        class MouseClass {
            ...
            _onPointerMove = this.onDocumentPointerMove.bind(this);
            _onPointerDown = this.onDocumentPointerDown.bind(this);
            _onPointerUp = this.onDocumentPointerUp.bind(this);
            ...
            init(container: HTMLElement) {
                ...
                this.listenerTarget.addEventListener('pointermove', this._onPointerMove as any);
                this.listenerTarget.addEventListener('pointerdown', this._onPointerDown as any);
                this.listenerTarget.addEventListener('pointerup', this._onPointerUp as any);
            ...
            dispose() {
                if (this.listenerTarget) {
                    this.listenerTarget.removeEventListener('pointermove', this._onPointerMove as any);
                    this.listenerTarget.removeEventListener('pointerdown', this._onPointerDown as any);
                    this.listenerTarget.removeEventListener('pointerup', this._onPointerUp as any);
                }
                if (this.docTarget) {
            ...
            onDocumentPointerUp(event: PointerEvent) {
                // optional: handle end of interaction
            }
