...
const Dashboard: React.FC = () => {
  const stats = [
    {
      ...
      bgGradient: 'linear-gradient(135deg, var(--mod-primary) 0%, var(--primary-light) 100%)',
    },
    {
      title: 'Present Today',
      value: '142',
      ...
      trend: 'up',
      icon: cilClock,
      color: 'var(--mod-secondary)',
      bgGradient: 'linear-gradient(135deg, var(--mod-secondary) 0%, var(--primary-light) 100%)',
    },
    {
      title: 'On Leave',
      value: '8',
      ...
      bgGradient: 'linear-gradient(135deg, var(--mod-accent) 0%, var(--secondary) 100%)',
    },
    {
      ...
      icon: cilChart,
      color: 'var(--mod-primary)',
      bgGradient: 'linear-gradient(135deg, var(--mod-primary) 0%, var(--accent) 100%)',
    },
  ];
  ...
  const upcomingEvents = [
    { title: 'Team Meeting', date: 'Today, 3:00 PM', type: 'meeting', color: 'var(--mod-primary)' },
    { title: 'Project Deadline', date: 'Tomorrow', type: 'deadline', color: 'var(--mod-secondary)' },
    { title: 'Company Holiday', date: 'Feb 15, 2026', type: 'holiday', color: 'var(--mod-accent)' },
    { title: 'Performance Review', date: 'Feb 20, 2026', type: 'review', color: 'var(--mod-primary)' },
  ];
